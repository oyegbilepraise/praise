      ...
      <ModalContent bg={useColorModeValue('white', 'rgb(36 41 47)')} rounded="xl" p="0">
        <ModalBody py="12" px={{ base: 8, md: 12 }}>
          ...
          <SimpleGrid columns={{ base: 3, md: 3 }} spacing={{ base: 3, md: 4 }}>
            <Flex
              onClick={() => handleClick('Email', 'mailto:oluwadhammieh@gmail.com')}
            ...
            <Flex
              onClick={() => handleClick('Github', 'https://github.com/oyegbilepraise')}
              direction="column" align="center" border="1px solid" cursor="pointer"
              borderColor={useColorModeValue("blackAlpha.200", "whiteAlpha.200")} rounded="2xl" px="8"
              py={{ base: 8, md: 10 }}
              _hover={{ bg: useColorModeValue('blackAlpha.50', 'whiteAlpha.50') }}
            ...
            <Flex
              onClick={() => handleClick('Codepen', 'https://codepen.io/oluwadhammieh-gmail-com')}
              direction="column" align="center" border="1px solid" cursor="pointer"
              borderColor={useColorModeValue("blackAlpha.200", "whiteAlpha.200")} rounded="2xl" px="8"
              py={{ base: 8, md: 10 }}
              _hover={{ bg: useColorModeValue('blackAlpha.50', 'whiteAlpha.50') }}
            ...
            <Flex
              onClick={() => handleClick('Telegram', 'https://t.me/oyegbilepraise')}
              direction="column" align="center" border="1px solid" cursor="pointer"
              borderColor={useColorModeValue("blackAlpha.200", "whiteAlpha.200")} rounded="2xl" px="8"
              py={{ base: 8, md: 10 }}
              _hover={{ bg: useColorModeValue('blackAlpha.50', 'whiteAlpha.50') }}
            ...
            <Flex
              onClick={() => handleClick('Linkedin', 'https://www.linkedin.com/in/oyegbile-praise-446459203/')}
              direction="column" align="center" border="1px solid" cursor="pointer"
              borderColor={useColorModeValue("blackAlpha.200", "whiteAlpha.200")} rounded="2xl" px="8"
              py={{ base: 8, md: 10 }}
              _hover={{ bg: useColorModeValue('blackAlpha.50', 'whiteAlpha.50') }}
            ...
            <Flex
              onClick={() => handleClick('Twitter', 'https://twitter.com/OyegbilePraise')}
              direction="column" align="center" border="1px solid" cursor="pointer"
              borderColor={useColorModeValue("blackAlpha.200", "whiteAlpha.200")} rounded="2xl" px="8"
              py={{ base: 8, md: 10 }}
              _hover={{ bg: useColorModeValue('blackAlpha.50', 'whiteAlpha.50') }}
