let projects = [
  {
    ...
    category: "web",
    title: "ILEYAH",
    image: "/images/projects/ileyah.png",
    link: "https://ileyah.com/",
    description: `Statisense is helping millions of tenants pay their rent in easy, monthly subscriptions across Africa.`,
  },
  {
    id: "statisense",
    category: "web",
    title: "Statisense",
    image: "/images/projects/statisense.png",
    link: "https://statisense.co/",
    description: `Statisense help businesses aggregate and convert complex customer data into simple visual insights using AI`,
  },
  {
    id: "clan",
    category: "web",
  ...
  },
  {
    ...
    description: `Cribstock is a community where young professionals can participate to own real estate as a means to wealth creation. Built with React, Next.js & Chakra UI`,
  },
  {
    id: "mizala-p2p",
    category: "web",
    ...
    description: `Mizala p2p is a peer-to-peer insurance network of over 2,000 people, where individuals pool their premiums together to insure against a common risk. Built with React, NextJS & Tailwind`,
  },
  {
    id: "mizala",
    category: "web",
    ...
    description: `Mizala aims to make insurance available and affordable for Nigerians and offers a variety of products ranging from auto insurance to peer to peer insurance. Built with React, NextJS & Tailwind`,
  },
  // {
  //   id: 'lcu',
  //   category: 'web',
  ...
  //   description: `Fieldoracle is an online marketplace connecting researchers with freelance agents to assist with data collection on the field. Built with Vue JS and Tailwind CSS`,
  // },
  // {
  //   id: 'taximoni',
  //   category: 'web',
  ...
  //   description: `Taximoni offers short term loans to Taxi drivers within certain communities. Built with NuxtJS and Ant design`
  // },
  // {
  //   id: "sonoracredit",
  //   category: "web",
  ...
  //   description: `Sonora credit provides simple and unique loans for all categories of people including businesses and individuals. Built with NextJS, Tailwind and Material css`,
  // },
  // {
  //   id: 'vendor-advisor',
  //   category: 'web',
